...
par(mfrow=c(2,2))
with(sub_power_data, plot(Time, Global_active_power, type="l", xlab="", ylab="Global Active Power"))
with(sub_power_data, plot(Time, Voltage, type="l", xlab="datetime", ylab="Voltage"))
...
legend("topright",c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),col=c("black","red","blue"), lty= 1, lwd=1, cex=0.3)
with(sub_power_data, plot(Time, Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power"))
